...
@section('panel')
    ...
    <div class="row gy-4">
        <div class="col-xxl-3 col-sm-6">
            <x-widget link="admin.users.all" icon="las la-users f-size--56" title="Total Users"
                value="{{ $widget['total_users'] }}" bg="primary" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget link="admin.users.active" icon="las la-user-check f-size--56" title="Active Users"
                value="{{ $widget['verified_users'] }}" bg="success" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget link="admin.users.email.unverified" icon="lar la-envelope f-size--56" title="Email Unverified Users"
                value="{{ $widget['email_unverified_users'] }}" bg="danger" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget link="admin.users.mobile.unverified" icon="las la-comment-slash f-size--56"
